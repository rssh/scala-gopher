...
{"l":"api/gopher.html","n":"Gopher","t":"val Gopher: JSGopher","d":"gopher"},
...
{"l":"api/gopher/DeadlockDetected.html","n":"DeadlockDetected","t":"class DeadlockDetected extends RuntimeException","d":"gopher/DeadlockDetected"},
...
{"l":"api/gopher/JSGopher.html","n":"JSGopher","t":"class JSGopher[F[_]](cfg: JSGopherConfig)(implicit evidence$1: CpsSchedulingMonad[F]) extends Gopher[F]","d":"gopher/JSGopher"},
{"l":"api/gopher/JSGopher.html","n":"makeChannel","t":"def makeChannel[A](bufSize: Int, autoClose: Boolean): Channel[F, A, A]","d":"gopher/JSGopher"},
{"l":"api/gopher/JSGopher.html","n":"time","t":"val time: Time[F]","d":"gopher/JSGopher"},
{"l":"api/gopher/JSGopher.html","n":"setLogFun","t":"def setLogFun(logFun: (Level, String, Throwable | Null) => Unit): (Level, String, Throwable | Null) => Unit","d":"gopher/JSGopher"},
{"l":"api/gopher/JSGopher.html","n":"log","t":"def log(level: Level, message: String, ex: Throwable | Null): Unit","d":"gopher/JSGopher"},
{"l":"api/gopher/JSGopher$.html","n":"JSGopher","t":"object JSGopher extends GopherAPI","d":"gopher/JSGopher$"},
{"l":"api/gopher/JSGopher$.html","n":"apply","t":"def apply[F[_]](cfg: GopherConfig)(implicit evidence$2: CpsSchedulingMonad[F]): Gopher[F]","d":"gopher/JSGopher$"},
{"l":"api/gopher/JSGopher$.html","n":"timer","t":"val timer: Timer","d":"gopher/JSGopher$"},
{"l":"api/gopher/JSGopherConfig.html","n":"JSGopherConfig","t":"class JSGopherConfig(flawor: String) extends GopherConfig","d":"gopher/JSGopherConfig"},
...
{"l":"api/gopher/SelectMacro$.html","n":"SelectMacro","t":"object SelectMacro","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"selectListenerBuilder","t":"def selectListenerBuilder[F[_], S, R, L <: SelectListeners[F, S, R]](constructor: Expr[L], caseDefs: List[SelectorCaseExpr[F, S, R]])(implicit evidence$19: Type[F], evidence$20: Type[S], evidence$21: Type[R], evidence$22: Type[L], Quotes): Expr[L]","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"buildSelectListenerRun","t":"def buildSelectListenerRun[F[_], S, R, L <: SelectListeners[F, S, R]](constructor: Expr[L], caseDefs: List[SelectorCaseExpr[F, S, R]], api: Expr[Gopher[F]])(implicit evidence$23: Type[F], evidence$24: Type[S], evidence$25: Type[R], evidence$26: Type[L], Quotes): Expr[R]","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"buildSelectListenerRunAsync","t":"def buildSelectListenerRunAsync[F[_], S, R, L <: SelectListeners[F, S, R]](constructor: Expr[L], caseDefs: List[SelectorCaseExpr[F, S, R]], api: Expr[Gopher[F]])(implicit evidence$27: Type[F], evidence$28: Type[S], evidence$29: Type[R], evidence$30: Type[L], Quotes): Expr[F[R]]","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"onceImpl","t":"def onceImpl[F[_], A](pf: Expr[PartialFunction[Any, A]], api: Expr[Gopher[F]])(implicit evidence$31: Type[F], evidence$32: Type[A], Quotes): Expr[A]","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"loopImpl","t":"def loopImpl[F[_]](pf: Expr[PartialFunction[Any, Boolean]], api: Expr[Gopher[F]])(implicit evidence$33: Type[F], Quotes): Expr[Unit]","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"foreverImpl","t":"def foreverImpl[F[_]](pf: Expr[PartialFunction[Any, Unit]], api: Expr[Gopher[F]])(implicit evidence$34: Type[F], Quotes): Expr[Unit]","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"aforeverImpl","t":"def aforeverImpl[F[_]](pf: Expr[PartialFunction[Any, Unit]], api: Expr[Gopher[F]])(implicit evidence$35: Type[F], Quotes): Expr[F[Unit]]","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"runImpl","t":"def runImpl[F[_], A, B](builder: List[SelectorCaseExpr[F, A, B]] => Expr[B], pf: Expr[PartialFunction[Any, A]])(implicit evidence$36: Type[F], evidence$37: Type[A], evidence$38: Type[B], Quotes): Expr[B]","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"runImplTree","t":"def runImplTree[F[_], A, B, C](using Quotes)(builder: List[SelectorCaseExpr[F, A, B]] => Expr[C], pf: Term)(implicit evidence$39: Type[F], evidence$40: Type[A], evidence$41: Type[B], evidence$42: Type[C]): Expr[C]","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"parseCaseDef","t":"def parseCaseDef[F[_], S, R](using Quotes)(caseDef: CaseDef)(implicit evidence$43: Type[F], evidence$44: Type[S], evidence$45: Type[R]): SelectorCaseExpr[F, S, R]","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"parseCaseDefGuard","t":"def parseCaseDefGuard(using Quotes)(caseDef: CaseDef): Map[String, Term]","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"parseSelectCondition","t":"def parseSelectCondition(using Quotes)(condition: Term, entries: Map[String, Term]): Map[String, Term]","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"makeLambda","t":"def makeLambda(using Quotes)(argName: String, argType: TypeRepr, oldArgSymbol: Symbol, body: Term): Term","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"substIdent","t":"def substIdent(using Quotes)(term: Term, fromSym: Symbol, toTerm: Term, owner: Symbol): Term","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$.html","n":"reportError","t":"def reportError(message: String, posExpr: Expr[_])(using Quotes): Nothing","d":"gopher/SelectMacro$"},
{"l":"api/gopher/SelectMacro$$SelectGroupExpr.html","n":"SelectGroupExpr","t":"trait SelectGroupExpr[F[_], S, R]","d":"gopher/SelectMacro$$SelectGroupExpr"},
{"l":"api/gopher/SelectMacro$$SelectGroupExpr.html","n":"toExprOf","t":"def toExprOf[X <: SelectListeners[F, S, R]]: Expr[X]","d":"gopher/SelectMacro$$SelectGroupExpr"},
{"l":"api/gopher/SelectMacro$$SelectorCaseExpr.html","n":"SelectorCaseExpr","t":"trait SelectorCaseExpr[F[_], S, R]","d":"gopher/SelectMacro$$SelectorCaseExpr"},
{"l":"api/gopher/SelectMacro$$SelectorCaseExpr.html","n":"Monad","t":"type Monad[X] = F[X]","d":"gopher/SelectMacro$$SelectorCaseExpr"},
{"l":"api/gopher/SelectMacro$$SelectorCaseExpr.html","n":"appended","t":"def appended[L <: SelectListeners[F, S, R]](base: Expr[L])(implicit evidence$46: Type[L], Quotes): Expr[L]","d":"gopher/SelectMacro$$SelectorCaseExpr"},
{"l":"api/gopher/SelectMacro$$ReadExpression.html","n":"ReadExpression","t":"class ReadExpression[F[_], A, S, R](ch: Expr[ReadChannel[F, A]], f: Expr[A => S], isDone: Boolean)(implicit evidence$4: Type[F], evidence$5: Type[A], evidence$6: Type[S], evidence$7: Type[R]) extends SelectorCaseExpr[F, S, R]","d":"gopher/SelectMacro$$ReadExpression"},
{"l":"api/gopher/SelectMacro$$ReadExpression.html","n":"appended","t":"def appended[L <: SelectListeners[F, S, R]](base: Expr[L])(implicit evidence$47: Type[L], Quotes): Expr[L]","d":"gopher/SelectMacro$$ReadExpression"},
{"l":"api/gopher/SelectMacro$$WriteExpression.html","n":"WriteExpression","t":"class WriteExpression[F[_], A, S, R](ch: Expr[WriteChannel[F, A]], a: Expr[A], f: Expr[A => S])(implicit evidence$8: Type[F], evidence$9: Type[A], evidence$10: Type[S], evidence$11: Type[R]) extends SelectorCaseExpr[F, S, R]","d":"gopher/SelectMacro$$WriteExpression"},
{"l":"api/gopher/SelectMacro$$WriteExpression.html","n":"appended","t":"def appended[L <: SelectListeners[F, S, R]](base: Expr[L])(implicit evidence$51: Type[L], Quotes): Expr[L]","d":"gopher/SelectMacro$$WriteExpression"},
{"l":"api/gopher/SelectMacro$$TimeoutExpression.html","n":"TimeoutExpression","t":"class TimeoutExpression[F[_], S, R](t: Expr[FiniteDuration], f: Expr[FiniteDuration => S])(implicit evidence$12: Type[F], evidence$13: Type[S], evidence$14: Type[R]) extends SelectorCaseExpr[F, S, R]","d":"gopher/SelectMacro$$TimeoutExpression"},
{"l":"api/gopher/SelectMacro$$TimeoutExpression.html","n":"appended","t":"def appended[L <: SelectListeners[F, S, R]](base: Expr[L])(implicit evidence$56: Type[L], Quotes): Expr[L]","d":"gopher/SelectMacro$$TimeoutExpression"},
{"l":"api/gopher/SelectMacro$$DoneExression.html","n":"DoneExression","t":"class DoneExression[F[_], A, S, R](ch: Expr[ReadChannel[F, A]], f: Expr[Unit => S])(implicit evidence$15: Type[F], evidence$16: Type[A], evidence$17: Type[S], evidence$18: Type[R]) extends SelectorCaseExpr[F, S, R]","d":"gopher/SelectMacro$$DoneExression"},
{"l":"api/gopher/SelectMacro$$DoneExression.html","n":"appended","t":"def appended[L <: SelectListeners[F, S, R]](base: Expr[L])(implicit evidence$60: Type[L], Quotes): Expr[L]","d":"gopher/SelectMacro$$DoneExression"},
...
{"l":"api/gopher/impl/BaseChannel.html","n":"BaseChannel","t":"class BaseChannel[F[_], A](val gopherApi: JSGopher[F]) extends Channel[F, A, A]","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"gopherApi","t":"val gopherApi: JSGopher[F]","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"readers","t":"val readers: Queue[Reader[A]]","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"writers","t":"val writers: Queue[Writer[A]]","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"doneReaders","t":"val doneReaders: Queue[Reader[Unit]]","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"closed","t":"var closed: Boolean","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"submitTask","t":"def submitTask(f: () => Unit): Unit","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"addReader","t":"def addReader(reader: Reader[A]): Unit","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"addWriter","t":"def addWriter(writer: Writer[A]): Unit","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"addDoneReader","t":"def addDoneReader(reader: Reader[Unit]): Unit","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"processClose","t":"def processClose(): Unit","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"exhauseQueue","t":"def exhauseQueue[T <: Expirable[A], A](queue: Queue[T], action: A => Unit): Unit","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"processCloseDone","t":"def processCloseDone(): Unit","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"processCloseReaders","t":"def processCloseReaders(): Unit","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"processCloseWriters","t":"def processCloseWriters(): Unit","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"isEmpty","t":"def isEmpty: Boolean","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BaseChannel.html","n":"process","t":"def process(): Unit","d":"gopher/impl/BaseChannel"},
{"l":"api/gopher/impl/BufferedChannel.html","n":"BufferedChannel","t":"class BufferedChannel[F[_], A](gopherApi: JSGopher[F], bufSize: Int)(implicit evidence$1: CpsAsyncMonad[F]) extends BaseChannel[F, A]","d":"gopher/impl/BufferedChannel"},
{"l":"api/gopher/impl/BufferedChannel.html","n":"ringBuffer","t":"val ringBuffer: Array[A]","d":"gopher/impl/BufferedChannel"},
{"l":"api/gopher/impl/BufferedChannel.html","n":"start","t":"var start: Int","d":"gopher/impl/BufferedChannel"},
{"l":"api/gopher/impl/BufferedChannel.html","n":"size","t":"var size: Int","d":"gopher/impl/BufferedChannel"},
{"l":"api/gopher/impl/BufferedChannel.html","n":"isEmpty","t":"def isEmpty: Boolean","d":"gopher/impl/BufferedChannel"},
{"l":"api/gopher/impl/BufferedChannel.html","n":"nElements","t":"def nElements: Int","d":"gopher/impl/BufferedChannel"},
{"l":"api/gopher/impl/BufferedChannel.html","n":"isFull","t":"def isFull: Boolean","d":"gopher/impl/BufferedChannel"},
...
{"l":"api/gopher/impl/JSTime.html","n":"JSTime","t":"class JSTime[F[_]](gopherAPI: JSGopher[F]) extends Time[F]","d":"gopher/impl/JSTime"},
{"l":"api/gopher/impl/JSTime.html","n":"schedule","t":"def schedule(fun: () => Unit, delay: FiniteDuration): Scheduled","d":"gopher/impl/JSTime"},
...
{"l":"api/gopher/impl/PromiseChannel.html","n":"PromiseChannel","t":"class PromiseChannel[F[_], A](gopherApi: JSGopher[F])(implicit evidence$1: CpsAsyncMonad[F]) extends BaseChannel[F, A]","d":"gopher/impl/PromiseChannel"},
...
{"l":"api/gopher/impl/UnbufferedChannel.html","n":"UnbufferedChannel","t":"class UnbufferedChannel[F[_], A](gopherApi: JSGopher[F])(implicit evidence$1: CpsAsyncMonad[F]) extends BaseChannel[F, A]","d":"gopher/impl/UnbufferedChannel"},
