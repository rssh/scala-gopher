...
{"l":"api/gopher/GopherAPI.html","n":"apply","t":"def apply[F[_]](cfg: GopherConfig)(`evidence$1`: CpsSchedulingMonad[F]): Gopher[F]","d":"gopher/GopherAPI"},
{"l":"api/gopher/GopherConfig.html","n":"GopherConfig","t":"trait GopherConfig","d":"gopher/GopherConfig"},
{"l":"api/gopher/JSGopher.html","n":"JSGopher","t":"class JSGopher[F[_]](cfg: JSGopherConfig)(`evidence$1`: CpsSchedulingMonad[F]) extends Gopher[F]","d":"gopher/JSGopher"},
...
{"l":"api/gopher/JSGopher$.html","n":"apply","t":"def apply[F[_]](cfg: GopherConfig)(`evidence$2`: CpsSchedulingMonad[F]): Gopher[F]","d":"gopher/JSGopher$"},
...
{"l":"api/gopher/Select$.html","n":"selectListenerBuilder","t":"def selectListenerBuilder[F[_], S, R, L <: SelectListeners[F, S, R]](constructor: Expr[L], caseDefs: List[SelectorCaseExpr[F, S, R]], api: Expr[Gopher[F]])(`evidence$20`: Type[F], `evidence$21`: Type[S], `evidence$22`: Type[R], `evidence$23`: Type[L], Quotes): Expr[R]","d":"gopher/Select$"},
{"l":"api/gopher/Select$.html","n":"onceImpl","t":"def onceImpl[F[_], A](pf: Expr[PartialFunction[Any, A]], api: Expr[Gopher[F]])(`evidence$24`: Type[F], `evidence$25`: Type[A], Quotes): Expr[A]","d":"gopher/Select$"},
{"l":"api/gopher/Select$.html","n":"loopImpl","t":"def loopImpl[F[_]](pf: Expr[PartialFunction[Any, Boolean]], api: Expr[Gopher[F]])(`evidence$26`: Type[F], Quotes): Expr[Unit]","d":"gopher/Select$"},
{"l":"api/gopher/Select$.html","n":"foreverImpl","t":"def foreverImpl[F[_]](pf: Expr[PartialFunction[Any, Unit]], api: Expr[Gopher[F]])(`evidence$27`: Type[F], Quotes): Expr[Unit]","d":"gopher/Select$"},
{"l":"api/gopher/Select$.html","n":"runImpl","t":"def runImpl[F[_], A, B](builder: List[SelectorCaseExpr[F, A, B]] => Expr[B], pf: Expr[PartialFunction[Any, A]])(`evidence$28`: Type[F], `evidence$29`: Type[A], `evidence$30`: Type[B], Quotes): Expr[B]","d":"gopher/Select$"},
{"l":"api/gopher/Select$.html","n":"runImplTree","t":"def runImplTree[F[_], A, B](using Quotes)(builder: List[SelectorCaseExpr[F, A, B]] => Expr[B], pf: Term)(`evidence$31`: Type[F], `evidence$32`: Type[A], `evidence$33`: Type[B]): Expr[B]","d":"gopher/Select$"},
{"l":"api/gopher/Select$.html","n":"parseCaseDef","t":"def parseCaseDef[F[_], S, R](using Quotes)(caseDef: CaseDef)(`evidence$34`: Type[F], `evidence$35`: Type[S], `evidence$36`: Type[R]): SelectorCaseExpr[F, S, R]","d":"gopher/Select$"},
...
{"l":"api/gopher/Select$$SelectorCaseExpr.html","n":"appended","t":"def appended[L <: SelectListeners[F, S, R]](base: Expr[L])(`evidence$37`: Type[L], Quotes): Expr[L]","d":"gopher/Select$$SelectorCaseExpr"},
{"l":"api/gopher/Select$$ReadExpression.html","n":"ReadExpression","t":"class ReadExpression[F[_], A, S, R](ch: Expr[ReadChannel[F, A]], f: Expr[A => S], isDone: Boolean)(`evidence$5`: Type[F], `evidence$6`: Type[A], `evidence$7`: Type[S], `evidence$8`: Type[R]) extends SelectorCaseExpr[F, S, R]","d":"gopher/Select$$ReadExpression"},
{"l":"api/gopher/Select$$ReadExpression.html","n":"appended","t":"def appended[L <: SelectListeners[F, S, R]](base: Expr[L])(`evidence$38`: Type[L], Quotes): Expr[L]","d":"gopher/Select$$ReadExpression"},
{"l":"api/gopher/Select$$WriteExpression.html","n":"WriteExpression","t":"class WriteExpression[F[_], A, S, R](ch: Expr[WriteChannel[F, A]], a: Expr[A], f: Expr[A => S])(`evidence$9`: Type[F], `evidence$10`: Type[A], `evidence$11`: Type[S], `evidence$12`: Type[R]) extends SelectorCaseExpr[F, S, R]","d":"gopher/Select$$WriteExpression"},
{"l":"api/gopher/Select$$WriteExpression.html","n":"appended","t":"def appended[L <: SelectListeners[F, S, R]](base: Expr[L])(`evidence$42`: Type[L], Quotes): Expr[L]","d":"gopher/Select$$WriteExpression"},
{"l":"api/gopher/Select$$TimeoutExpression.html","n":"TimeoutExpression","t":"class TimeoutExpression[F[_], S, R](t: Expr[FiniteDuration], f: Expr[FiniteDuration => S])(`evidence$13`: Type[F], `evidence$14`: Type[S], `evidence$15`: Type[R]) extends SelectorCaseExpr[F, S, R]","d":"gopher/Select$$TimeoutExpression"},
{"l":"api/gopher/Select$$TimeoutExpression.html","n":"appended","t":"def appended[L <: SelectListeners[F, S, R]](base: Expr[L])(`evidence$47`: Type[L], Quotes): Expr[L]","d":"gopher/Select$$TimeoutExpression"},
{"l":"api/gopher/Select$$DoneExression.html","n":"DoneExression","t":"class DoneExression[F[_], A, S, R](ch: Expr[ReadChannel[F, A]], f: Expr[Unit => S])(`evidence$16`: Type[F], `evidence$17`: Type[A], `evidence$18`: Type[S], `evidence$19`: Type[R]) extends SelectorCaseExpr[F, S, R]","d":"gopher/Select$$DoneExression"},
{"l":"api/gopher/Select$$DoneExression.html","n":"appended","t":"def appended[L <: SelectListeners[F, S, R]](base: Expr[L])(`evidence$51`: Type[L], Quotes): Expr[L]","d":"gopher/Select$$DoneExression"},
...
{"l":"api/gopher/SharedGopherAPI$.html","n":"apply","t":"def apply[F[_]](cfg: GopherConfig)(`evidence$2`: CpsSchedulingMonad[F]): Gopher[F]","d":"gopher/SharedGopherAPI$"},
...
{"l":"api/gopher/impl/BufferedChannel.html","n":"BufferedChannel","t":"class BufferedChannel[F[_], A](gopherApi: JSGopher[F], bufSize: Int)(`evidence$1`: CpsAsyncMonad[F]) extends BaseChannel[F, A]","d":"gopher/impl/BufferedChannel"},
...
{"l":"api/gopher/impl/PromiseChannel.html","n":"PromiseChannel","t":"class PromiseChannel[F[_], A](gopherApi: JSGopher[F])(`evidence$1`: CpsAsyncMonad[F]) extends BaseChannel[F, A]","d":"gopher/impl/PromiseChannel"},
...
{"l":"api/gopher/impl/UnbufferedChannel.html","n":"UnbufferedChannel","t":"class UnbufferedChannel[F[_], A](gopherApi: JSGopher[F])(`evidence$1`: CpsAsyncMonad[F]) extends BaseChannel[F, A]","d":"gopher/impl/UnbufferedChannel"},
...
{"l":"api/gopher/monads/ReadChannelCpsMonad.html","n":"ReadChannelCpsMonad","t":"given ReadChannelCpsMonad[F[_]](using `x$1`: Gopher[F]): CpsMonad[[A] =>> ReadChannel[F, A]]","d":"gopher/monads"},
...
{"l":"api/gopher/monads/ReadTryChannelCpsMonad.html","n":"ReadTryChannelCpsMonad","t":"given ReadTryChannelCpsMonad[F[_]](using `x$1`: Gopher[F]): CpsAsyncMonad[[A] =>> ReadChannel[F, Try[A]]]","d":"gopher/monads"},
...
{"l":"api/gopher/monads/futureToReadChannel.html","n":"futureToReadChannel","t":"given futureToReadChannel[F[_]](using `x$1`: Gopher[F]): CpsMonadConversion[F, [A] =>> ReadChannel[F, A]]","d":"gopher/monads"},
...
{"l":"api/gopher/monads/readChannelToTryReadChannel.html","n":"readChannelToTryReadChannel","t":"given readChannelToTryReadChannel[F[_]](using `x$1`: Gopher[F]): CpsMonadConversion[[A] =>> ReadChannel[F, A], [A] =>> ReadChannel[F, Try[A]]]","d":"gopher/monads"},
...
{"l":"api/gopher/monads/ReadChannelCpsMonad.html","n":"ReadChannelCpsMonad","t":"given ReadChannelCpsMonad[F[_]](using `x$1`: Gopher[F]): CpsMonad[[A] =>> ReadChannel[F, A]]","d":"gopher/monads/ReadChannelCpsMonad"},
...
{"l":"api/gopher/monads/ReadTryChannelCpsMonad.html","n":"ReadTryChannelCpsMonad","t":"given ReadTryChannelCpsMonad[F[_]](using `x$1`: Gopher[F]): CpsAsyncMonad[[A] =>> ReadChannel[F, Try[A]]]","d":"gopher/monads/ReadTryChannelCpsMonad"},
...
{"l":"api/gopher/monads/futureToReadChannel.html","n":"futureToReadChannel","t":"given futureToReadChannel[F[_]](using `x$1`: Gopher[F]): CpsMonadConversion[F, [A] =>> ReadChannel[F, A]]","d":"gopher/monads/futureToReadChannel"},
...
{"l":"api/gopher/monads/readChannelToTryReadChannel.html","n":"readChannelToTryReadChannel","t":"given readChannelToTryReadChannel[F[_]](using `x$1`: Gopher[F]): CpsMonadConversion[[A] =>> ReadChannel[F, A], [A] =>> ReadChannel[F, Try[A]]]","d":"gopher/monads/readChannelToTryReadChannel"},
