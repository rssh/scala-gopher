...
val sharedSettings = Seq(
    ...
    libraryDependencies += "com.github.rssh" %%% "dotty-cps-async" % "0.5.0-SNAPSHOT",
    libraryDependencies += "org.scalameta" %%% "munit" % "0.7.22+7-1e1017a3+20210228-1512-SNAPSHOT" % Test,
